...
<body>
	<div class="container">
		...
		<div class="h2 text-center">Thank you for Shopping at Shop Online. The amount of <b class="text-success"><i class="fa fa-inr" aria-hidden="true"></i> ${totalAmount}</b> deducted from your account.</div>
