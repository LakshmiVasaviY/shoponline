...
<title>Shop Online Product-Page</title>
</head>
<body>
	<div class="container">
		<div class="well">
			...
			<div class="container">
				...
				<div class="col-md-5 col-xs-7">
					<div class="h2">${selectedProduct.name}</div><br>
					...
					<div class="h4"><b>Quantity</b> <input type="text"  class="form-control" id="quant" name="quant" size=6> </div>
